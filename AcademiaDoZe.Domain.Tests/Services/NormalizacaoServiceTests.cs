...
public class NormalizacaoServiceTests
{
    ...
    [Fact(DisplayName = "NormalizacaoService: LimparTodosEspacos com tabs e quebras de linha")]
    public void Deve_Remover_TabsEQuebras_Quando_LimparTodosEspacosChamado()
    {
        var result = NormalizadoService.LimparTodosEspacos("a\tb\nc");
        Assert.Equal("a\tb\nc".Replace(" ", ""), result); 
    }
