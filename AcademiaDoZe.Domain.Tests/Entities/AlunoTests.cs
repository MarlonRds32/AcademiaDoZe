...
public class AlunoTests
{
    ...
    [Fact(DisplayName = "Aluno: CPF inválido propaga notificação -> CPF_DIGITOS")]
    public void Deve_Falhar_Criacao_Quando_CpfComPoucosDigitos()
    {
        var result = Aluno.Criar(1, "João", "123.456", DateOnly.FromDateTime(DateTime.Today.AddYears(-20)),
            "(11) 91234-5678", "user@example.com",
            Logradouro.Criar(1, "12345-678", "Rua Teste", "Bairro", "Cidade", "SP", "Brasil").Value!,
            "123", "", "Abcdef", Arquivo.Criar(new byte[] { 1, 2, 3 }).Value!);
