...
public class AcessoAlunoTests
{
...

    {
        ...
        Assert
        .Equal
        (aluno.Id, result.Value!.Aluno.Id);
    ...
    [Fact(DisplayName = "AcessoAluno: 05:59 é inválido (1 minuto antes do limite)")]
    public void Deve_Falhar_Quando_HorarioUmMinutoAntesDoLimite()
    {
        // Arrange
